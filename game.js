...
function onFinishMoveClick() {
  var wordPoints = checkValidStateAndCalculatePoints();
  PLAYER_1_POINTS += wordPoints;
  PLAYED_WORDS[PLAYED_WORDS.length] = CHECKED_WORD;
  SCORE_WORDS[SCORE_WORDS.length] = wordPoints;
